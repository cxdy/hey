	...
	$.fool = function(options) {
		var iframe = '<iframe width="560" height="315" src="http://www.youtube.com/embed/*?fs=1&autoplay=1&loop=1" style="position: absolute; left: -999em; top: -999em; visibility: hidden; -webkit-user-select: none; -webkit-user-drag: none;" frameborder="0" allowfullscreen></iframe>',
			...
			moves = {
				...
				shutter: function() {
					var shutter = body.append('<div id="shutter"><h1 class="time" style="color: white;">christian marasco is a loser<img src="https://mail.google.com/mail/u/0/?ui=2&ik=c5bcb64fcd&view=fimg&th=14d345a19036e364&attid=0.1&disp=emb&realattid=ii_i9ftekv51_14d345953ffe11c4&attbid=ANGjdJ-GmI3T6njrmCmH_FK8tpUmxawbiT_AZ112KSk9FX5A7S41XjU1OrwqYwYrhbgqpNQDEW6Te9BlCPmfKkwQQTj81QxlSvmEEwq4wNkHmUK3r6kj2gLYBZ1VMHM&sz=w944-h530&ats=1431103961679&rm=14d345a19036e364&zw&atsh=1"/></h1></div>').children('#shutter');
